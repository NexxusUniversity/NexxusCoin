...
public:
    CMainParams() {
        ...
        string hashMK = genesis.hashMerkleRoot.ToString();
        assert(hashGenesisBlock == uint256("0x2aff1d957e1120df712a58eea58c964ae1532e95090f8a9ba3ef8c7e62d72611"));
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        string hash = hashGenesisBlock.ToString();
        assert(hashGenesisBlock == uint256("0xd24a330cf7c75b5369fae97667052795dcf6ba9443e571eace829eccb2b87c7e"));
