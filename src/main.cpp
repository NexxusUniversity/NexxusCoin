...
#if defined(NDEBUG)
# error "Nexxus Coin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Nexxus Coin Signed Message:\n";
...
int64_t GetProofOfWorkRewardPremine(int64_t nFees)
{
    int64_t nSubsidy = 299e+6 * COIN;

    LogPrint("creation", "GetProofOfWorkRewardPremine() : create=%s nSubsidy=%d\n", FormatMoney(nSubsidy), nSubsidy);
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    {
        int64_t nReward = 0;
        nReward = GetProofOfWorkReward(nFees);
...
bool CBlock::AcceptBlock()
{
    ...
    if (nBits != GetNextTargetRequired(pindexPrev, IsProofOfStake()) && !(nHeight == 319002 || nHeight == 319003))
...
{
    RenameThread("nexxuscoin-loadblk");
